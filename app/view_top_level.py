...
class TopLevelShowingInfo(tk.Toplevel):
    def __init__(self, vc, *args, **kwargs):
        ...
        self.total_content = tk.IntVar()
        tk.Label(self, textvariable=self.total_content).pack()

        self.data_tree = ttk.Treeview(self)
        self.data_tree['show'] = 'headings'
        self.data_tree['columns'] = (
            'date_col', 'amount_col', 'comment_col')
        ...
        self.data_tree.column("comment_col", width=230)
        ...
        self.data_tree.pack()
        self.data_tree.bind("<Double-1>", self.vc.open_editing)
    ...
    def configure_win(self):
        ...
        self.resizable(width=False, height=False)
        self.protocol('WM_DELETE_WINDOW', self.vc.on_closing)
        self.vc.center_main_window(self, width=450, height=200)
...
class TopLevelEditArchiveItem(tk.Toplevel):
    def __init__(self, vc, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.vc = vc
        self.configure_win()
        ...
        tk.Button(self, text='OK', command=self.vc.edit_data).grid(
            row=4, column=1)
    ...
    def configure_win(self):
        ...
        self.resizable(width=False, height=False)
        self.protocol('WM_DELETE_WINDOW', self.vc.on_closing)
        self.vc.center_main_window(self, width=517, height=80)
